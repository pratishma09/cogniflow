...
const pathname=useLocation();
  ...
  return (
    <div className="fixed top-0 z-50 bg-n-8/90  border-b border-n-6 lg:bg-n-8/90 backdrop-blur-sm">
      <div className="flex items-center px-5 lg:px-7.5 xl:px-10 max-lg:py-4">
      <a className="flex items-center gap-2 w-[12rem] xl:mr-8" href="#hero">
        <img src={brainwaveSymbol} width={30} alt="" /><p className="text-lg font-medium ">CogniFlow</p>
      </a>
